  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-1 max-w-5xl mx-auto w-full px-4 sm:px-6 py-6 sm:py-10 flex flex-col gap-8">
        ...
        <section className="text-center py-4 flex flex-col items-center gap-3">
          ...
          <p className="text-sm text-stone-500 dark:text-stone-400 max-w-md">
            Lihat buku menu lengkap kami di bawah. Ada pertanyaan? Hubungi CS kami langsung.
          </p>
          <a href={waLink} target="_blank" rel="noopener noreferrer" className="mt-1 inline-flex items-center gap-2 px-5 py-2.5 rounded-full bg-green-600 hover:bg-green-500 text-white text-sm font-medium transition-all duration-200 hover:-translate-y-0.5 hover:shadow-lg hover:shadow-green-600/30">
      ...
      <footer className="border-t border-stone-200 dark:border-dark-50 py-6 px-4 text-center">
        <p className="text-xs text-stone-400 dark:text-stone-600 tracking-wider uppercase">Tea Co + · Hubungi CS: +62 811-2777-555</p>
      </footer>
