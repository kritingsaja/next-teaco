      ...
      <main className="flex-1 max-w-5xl mx-auto w-full px-4 sm:px-6 py-8 sm:py-12 flex flex-col gap-8">
        ...
        <section className="text-center py-4 flex flex-col items-center gap-4">
          ...
          <div className="flex flex-wrap items-center justify-center gap-3 mt-1">
            <a href={waLink} target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 px-5 py-2.5 rounded-full bg-green-600 hover:bg-green-500 text-white text-sm font-medium transition-all duration-200 hover:-translate-y-0.5 hover:shadow-lg hover:shadow-green-600/30">
            ...
            <a href={mapsLink} target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 px-5 py-2.5 rounded-full bg-stone-100 dark:bg-dark-100 border border-stone-200 dark:border-dark-50 text-stone-700 dark:text-stone-300 text-sm font-medium transition-all duration-200 hover:-translate-y-0.5 hover:border-gold-400 hover:text-gold-400">
