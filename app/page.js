    ...
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-1 max-w-5xl mx-auto w-full px-4 sm:px-6 py-6 sm:py-10 flex flex-col gap-8">
        <section className="text-center py-6 flex flex-col items-center gap-3">
          <p className="text-xs tracking-[0.25em] uppercase text-stone-400 dark:text-stone-500">Ramadan 1446 H</p>
          ...
          <p className="text-sm text-stone-500 dark:text-stone-400 max-w-md">Nikmati menu spesial Ramadan kami. Lihat buku menu lengkap di bawah ini.</p>
          <a href="/reservasi" className="mt-2 inline-flex items-center gap-2 px-5 py-2.5 rounded-full bg-gold-400 hover:bg-gold-500 text-white text-sm font-medium transition-all duration-200">Reservasi Sekarang</a>
        </section>
      ...
      <footer className="border-t border-stone-200 dark:border-dark-50 py-6 px-4 text-center">
        <p className="text-xs text-stone-400 dark:text-stone-600 tracking-wider uppercase">Cek Ketersediaan · Ramadan 1446 H · Tea Co +</p>
      </footer>
